(function(){
    ...
    l.button = function(b, a) {
        ...
        var p = function() {
            var e = "";
            m ? e = '<span class="CboxCloseBtn"></span>' : (c && "users" == a.showCount && (e += '<span class="CboxCount">' + ("N") + "</span>"), k && "messages" == a.showCount && (e += '<span class="CboxCount">' + ("N") + "</span>"), e = a.showLogo ? e + '<span class="CboxOpenBtn"><img src="bg/img/bulletin.png" style="width: 70px; position: absolute; left: 30px; top: -70px;transform: rotate(90deg);"></span>' : e + '<span class="CboxOpenBtn"></span>');
            return e;
        };
        f.innerHTML = "";
        var y = !1,
